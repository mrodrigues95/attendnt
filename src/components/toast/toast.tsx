...
>(({ className, ...props }, ref) => (
	<ToastPrimitives.Action
		...
		className={cn(
			...
			'hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
			className,
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<ToastPrimitives.Close
		ref={ref}
		className={cn(
			'absolute right-2 top-2 rounded-md p-1 text-slate-900/50 opacity-0 transition-opacity',
			'hover:text-slate-900 focus:opacity-100 focus:outline-none focus:ring-2',
